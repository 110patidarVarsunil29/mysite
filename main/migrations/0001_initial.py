    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tutorial_published', models.DateTimeField(default=datetime.datetime(2020, 4, 4, 12, 48, 5, 14444), verbose_name='date published')),
                ('tutorial_slug', models.CharField(default=1, max_length=210)),
